...
description: "Full SEO audit using GSC, URL Inspection, PageSpeed, crawl, metadata, schema, search intent, and Core Web Vitals; surfaces quick wins and a 30-day plan. Use for SEO, rankings, organic traffic, Search Console, keywords, traffic drops, technical SEO, meta tags, structured data, indexing, crawl errors, cannibalization, URL inspection, page speed, Lighthouse, LCP, INP, CLS, or organic-search questions. Requires TopRank-style scripts under SKILL_SCRIPTS, ~/.toprank cache, and gcloud GSC auth (see ../shared/preamble.md)."
---
